...
public class InternalTemporaryExposureKey {

    private final ENInterval interval;
    private final byte[] key = new byte[TEK_LENGTH];

    public InternalTemporaryExposureKey(final ENInterval interval, final byte[] value) {
    ...
    public InternalTemporaryExposureKey(final long timestamp, final byte[] rawKey) {
